    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="w-full max-w-5xl flex bg-gray-800/50 backdrop-blur-lg shadow-2xl rounded-2xl overflow-hidden border border-gray-700/30 transform hover:scale-[1.01] transition-all duration-300">
        ...
        <div className="w-1/2 p-12 bg-gray-900/50 backdrop-blur-sm">
          <h2 className="text-3xl font-bold text-yellow-400 mb-8">Create Account</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="block text-yellow-400/90 font-medium text-sm tracking-wide">Full Name</label>
            ...
            <p className="text-center text-gray-400">
              Already have an account? <Link to="/login" className="text-yellow-400 hover:text-yellow-300 font-medium transition-colors duration-300">Log In</Link>
            </p>
          </form>
        </div>
      </div>
